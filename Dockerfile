...
RUN apt-get install -y bind9-dnsutils bind9-host bison cmake curl flex gcc g++ iperf3 iproute2 iputils-ping jq ldap-utils make man-db net-tools netcat nmap openssl postgresql-client python-is-python3 python3 python3-pip python3-venv python3-wheel sudo tcpdump traceroute vim
